...
#------------------------------------------------- 
    ...
    close=np.array(list(close))
    high=np.array(list(high))
    low=np.array(list(low))
    opens=np.array(list(opens))
    pctchange=np.array(list(pctchange))
...
#-------------------------------------------------  
#-------------------------------------------------  
    train_data_one=convert_data(close_train_data_one,high_train_data_one,low_train_data_one,open_train_data_one,close_train_data_one,high_train_data_one,low_train_data_one,open_train_data_one,input_size=input_num)
    train_data_two=convert_data(close_train_data_two,high_train_data_two,low_train_data_two,open_train_data_two,close_train_data_two,high_train_data_two,low_train_data_two,open_train_data_two,input_size=1)
    test_data_one=convert_data(close_test_data_one,high_test_data_one,low_test_data_one,open_test_data_one,close_test_data_one,high_test_data_one,low_test_data_one,open_test_data_one,input_size=input_num)
    test_data_two=convert_data(close_test_data_two,high_test_data_two,low_test_data_two,open_test_data_two,close_test_data_two,high_test_data_two,low_test_data_two,open_test_data_two,input_size=1)
...
#       
#    line1,=axes.plot(range(len(current_loss)), current_loss, 'r',label='Train loss',linewidth=2)  
#    line2,=axes.plot(range(len(validation_loss)), validation_loss, 'b',label='validation_loss',linewidth=2)     
#    axes.grid()  
#    fig.tight_layout()  
...
def convert_data(data_one,data_two,data_three,data_four,data_five,data_six,data_seven,data_eight,input_size):
    ...
    lasts=np.array(last,np.float32)
...
#        print data[-1]
#        
#        print data[i+input_num+1:i+input_num+2]
#        
...
#    
#original_data=get_index_data('000001')
#X_train,X_test,Y_train,Y_test,ss_y=get_all_data(
#        original_data,input_num=100,test_day=1,train_start=0,test_end=4271, train_end=4270,train=True)
#
