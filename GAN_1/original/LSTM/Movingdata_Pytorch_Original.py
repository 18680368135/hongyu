...
#-------------------------------------------------
    ...
    train_data_one=convert_data(close_train_data_one, input_size=input_num)
    train_data_two=convert_data(close_train_data_two, input_size=1)
    test_data_one=convert_data(close_test_data_one, input_size=input_num)
    test_data_two=convert_data(close_test_data_two, input_size=1)
...
def convert_data(data_one,input_size):
    i=0
    last=[]
    data_one=list(data_one)
    ...
    lasts=np.reshape(last,(-1,1,input_size))
    lasts=np.transpose(lasts,(0,2,1))
