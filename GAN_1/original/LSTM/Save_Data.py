...
#    print("the average MAPE is :",MAPE(prediction,test_y))
    ...
    if os.path.isfile('/home/tom/why/GAN_1/original/LSTM/data.csv'):
        dataframe.to_csv('/home/tom/why/GAN_1/original/LSTM/data.csv',mode='a',header=False,index=False)
    else:
        dataframe.to_csv('/home/tom/why/GAN_1/original/LSTM/data.csv',index=False)
