...
#    print("the average MAPE is :",MAPE(prediction,test_y))
    ...
    if os.path.isfile('/home/tom/zjr/volity/Wavenet/data.csv'):
        dataframe.to_csv('/home/tom/zjr/volity/Wavenet/data.csv',mode='a',header=False,index=False)
    else:
        dataframe.to_csv('/home/tom/zjr/volity/Wavenet/data.csv',index=False)
