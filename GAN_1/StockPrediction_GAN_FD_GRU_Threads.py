...
from ALEGANFD_GRU_process import GANFD
import pymysql, os
import numpy as np
import pandas as pd
...
GPU_useage = multiprocessing.Array('i', [4, 4, 0, 4, 4, 4, 4, 4])
...
def readqueue(q):
    ...
    df.to_csv('./loss_GRU_GAN/result.csv', index=False, sep=',')
