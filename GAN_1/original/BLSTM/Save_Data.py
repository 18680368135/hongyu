...
#    print("the average MAPE is :",MAPE(prediction,test_y))
    ...
    if os.path.isfile('/home/tom/zjr/original/BLSTM/data.csv'):
        dataframe.to_csv('/home/tom/zjr/original/BLSTM/data.csv',mode='a',header=False,index=False)
    else:
        dataframe.to_csv('/home/tom/zjr/original/BLSTM/data.csv',index=False)
