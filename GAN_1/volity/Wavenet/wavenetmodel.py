...
class WaveLSTM(nn.Module):
    def __init__(self,  in_depth, res_channels, skip_channels, dilation_depth,kernel_size, n_repeat):
        ...
        self.Wavenet = Wavenet1.WaveNet(in_depth=in_depth, res_channels=res_channels, skip_channels=skip_channels, dilation_depth=dilation_depth,kernel_size=kernel_size, n_repeat=n_repeat) 
