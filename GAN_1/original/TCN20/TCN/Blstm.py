...
class Bi_LSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
        ...
        self.fc = nn.Linear(hidden_size*2, self.fullyunit1)  # 2 for bidirection
        self.fc2 = nn.Linear(self.fullyunit1,self.fullyunit2)
        self.fc3 = nn.Linear(self.fullyunit2,num_classes)
    def forward(self, x):
        # Set initial states
#-------------------------------------------------
