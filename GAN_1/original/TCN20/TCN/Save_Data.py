...
#    print("the average MAPE is :",MAPE(prediction,test_y))
    ...
    if os.path.isfile('/home/user/zjr/original/TCN/data.csv'):
        dataframe.to_csv('/home/user/zjr/original/TCN/data.csv',mode='a',header=False,index=False)
    else:
        dataframe.to_csv('/home/user/zjr/original/TCN/data.csv',index=False)
