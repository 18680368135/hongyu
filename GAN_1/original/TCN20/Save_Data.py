...
#    print("the average MAPE is :",MAPE(prediction,test_y))
    ...
    if os.path.isfile('/home/tom/zjr/original/TCN20/data.csv'):
        dataframe.to_csv('/home/tom/zjr/original/TCN20/data.csv',mode='a',header=False,index=False)
    else:
        dataframe.to_csv('/home/tom/zjr/original/TCN20/data.csv',index=False)
