...
public class Sent163Email {



    static String HOST = "smtp.163.com"; // smtp服务器
    static String FROM = "m_wanghongyu@163.com"; // 发件人地址
    static String TO = "18680368138@163.com"; // 收件人地址
    static String AFFIX = ""; // 附件地址
    static String AFFIXNAME = "附件"; // 附件名称
    static String USER = "m_wanghongyu@163.com"; // 用户名
    static String PWD = "918735abc"; // 163的授权码
    static String SUBJECT = "hello world"; // 邮件标题
    static String[] TOS = {"18680368138@163.com", "18680368139@163.com"};
