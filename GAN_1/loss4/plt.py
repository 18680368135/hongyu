...
plt.plot(x, predict_values, color='red', label=title[2])
plt.title("Shanghai Composite Index Continuously Forecasts 50 Days", fontsize='x-large')
plt.legend()

plt.xlabel('day')
plt.ylabel('value')
plt.savefig('./上证50days.jpg')
plt.show()
